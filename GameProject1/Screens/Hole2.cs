...
namespace GameProject1.Screens
{
    public class Hole2 : GameScreen
    {
        ...
        private bool switch_holes = false;
        ...
        public Hole2(float highScore)
        {
            //Carry over time from last hole
        ...
        public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
        {
            ...
            if(switch_holes)
            {
                ...
                windParticleSystem.RemoveAllParticles();
                windParticleSystem.Enabled = false;
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new Hole3(high_score_time + past_high_score));
            }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                _spriteBatch.DrawString(font, "Hole 2", new Vector2(775, 500), Color.Gold);
            }
            ...
            _spriteBatch.DrawString(high_score_font, "Hole 2", new Vector2(1820, 1040), Color.Gold);
